...
const TABLE_HEAD = [
  ...
  { id: 'parentName', label: 'Parent Name', align: 'left' },
    ...
    <Page title="Student: List">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          action={
            <NextLink href={PATH_DASHBOARD.student.new} passHref>
              ...
              <Table size={dense ? 'small' : 'medium'}>
                ...
                <TableBody>
                  {stableSort(filteredUsers, getComparator(order, orderBy))
                    ...
                    .map((row) => {
                      const { id, displayName, school, email, parentName, phoneNumber, role, isVerified, status, imageUrl } = row;
