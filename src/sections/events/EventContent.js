...
const CoverImage = styled('div')(({ theme, src }) => ({
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ p: 3 }}>
            ...
            <Box
              ...
              gap={1}
            >
              <Iconify icon={'bi:clock-fill'} width={20} height={20} color={'primary'} />
              <Stack>
                <Typography variant="body2">Time:</Typography>
                <Typography variant="subtitle1"> {currentEvent?.startTime}</Typography>
              </Stack>
            </Box>
          ...
          <Card sx={{ p: 1, mt: 3 }}>
            <Box p={3} display="flex" alignItems="flex-start">
              <AvatarWrapper src={currentEvent?.cover} alt={currentEvent?.location} variant="rounded" />
              <Box
