...
export default function InvoiceList() {
  ...
  const handleEditRow = (id) => {
    push(PATH_TEACHER.invoice.edit(id));
  };

  const handleViewRow = (id) => {
    push(PATH_TEACHER.invoice.view(id));
  };
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Invoices', href: PATH_TEACHER.invoice.root },
            { name: 'List' },
          ]}
          action={
            <NextLink href={PATH_TEACHER.invoice.new} passHref>
